...
;+
; :Description:   
;    Function for estimation of ENL for polSAR covariance images
...
;       Mort Canty (2014)        
;-
function enlml, fid, dims, bands, enl=enl_ml, wsize=wsize 
...
;  Standard error handling.
   ...
   if n_elements(wsize) eq 0 then ws = 7 else ws = wsize
